<template>
  <div id="Choice-Turntable-Model" @click="start">
...
function drawCarousel() {
  ...
  const canvas = document.querySelector(
    "#Choice-Turntable-Model .turntable"
...
function start() {
  if (animation?.playState !== "running") {
    const arrow = document.querySelector("#Choice-Turntable-Model .arrow")
